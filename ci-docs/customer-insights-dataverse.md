...
| Звання             | String      | Назва або ім’я справи                                                               |
...
| СегментЧленствоТип | String       | Тип клієнта для запису про членство в цьому сегменті. Підтримує кілька типів, таких як Клієнт, Контакт або Обліковий запис. За замовчуванням: клієнт  |
