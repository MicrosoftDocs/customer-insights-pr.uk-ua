...
1. Виберіть " **Редагувати відомості** " поруч із пунктом "Без назви сегмента". Укажіть ім'я сегмента та змініть запропоноване **Ім’я вихідної сутності** для цього сегмента. За бажанням додайте опис і [теги](work-with-tags-columns.md#manage-tags) до сегмента.
...
> - Правила та умови можна переміщувати до інших місць у визначенні сегмента. Виберіть вертикальні три крапки () поруч&vellip; із правилом або умовою та виберіть, як і куди його перемістити.
...
5. Укажіть ім'я **сутності** "Ім'я **" та**"Output" для сегмента. За бажанням додайте [теги](work-with-tags-columns.md#manage-tags).
