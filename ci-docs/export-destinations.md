...
- **Експорт** даних дає змогу експортувати будь-який тип сутності, доступний у Customer Insights. Вибрані для експорту сутності експортуються з усіма полями даних, метаданими, схемами та даними зіставлення. 
- **Експорт сегментів** дозволяє експортувати суб'єкти сегмента з Customer Insights. Сегменти представляють собою списки профілів клієнтів. Під час налаштування експорту слід вибрати включені поля даних, залежно від цільової системи, куди дані експортуватимуться. 
