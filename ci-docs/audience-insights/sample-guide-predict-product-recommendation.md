...
Contoso – це компанія, яка виробляє каву та кавоварки високої якості і реалізує продукцію на власному веб-сайті Contoso Coffee. Їх мета — зрозуміти, які продукти слід рекомендувати своїм клієнтам, що звертаються до них повторно. Відомості щодо того, що клієнти, найімовірніше, **можуть придбати**, допоможе заощадити зусилля на маркетинг та зосередитись на конкретних товарах.
