...
Показники допомагають краще розуміти поведінку користувачів та ефективність бізнесу. Вони оцінюють відповідні значення з [уніфікованих профілів](data-unification.md). Наприклад, компанія хоче бачити *загальний обсяг витрат для кожного клієнта*, щоб зрозуміти історію покупок окремого клієнта або виміряти *загальний обсяг збуту компанії*, щоб зрозуміти сукупний дохід у всій компанії.  
...
1. Виберіть **Редагувати ім’я** та вкажіть **Ім’я** для показника. 
   > [!NOTE]
   > Якщо конфігурація нового показника містить лише два поля, наприклад CustomerID і одне обчислення, результат буде додано як новий стовпець до створеної системою сутності, що називається Customer_Measure. І ви зможете бачити значення цього показника уніфікованому профілі клієнта. Інші показники також створюватимуть власні сутності.
...
1. Якщо в даних присутні значення, які потрібно замінити цілими числами, наприклад, замінити значення *null* на *0*, виберіть **Правила**. Налаштуйте правило та переконайтеся, що в якості замін вибрано лише цілі числа.
...
1. У розділі **Установити період часу** визначте часові рамки для даних, які слід використовувати. Виберіть **Увесь час**, якщо потрібно, щоб новий показник враховував увесь набір даних. Або якщо потрібно, щоб показник був зосереджений на **Певному періоді часу**.
