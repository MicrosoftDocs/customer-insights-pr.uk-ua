...
Адміністратори можуть налаштувати статистику клієнтів на [використання наявного Dataverse середовища](create-environment.md) під час створення середовища статистики клієнтів. Якщо вказати URL-адресу у середовищі Dataverse, його можна прикріпити до нового середовища аналізу аудиторії. Статистика клієнтів і Dataverse середовища повинні розміщуватися в одному регіоні. 
...
|--------------------|--------------|-----------------------------|
| Ідентифікатор клієнта        | String       | Ідентифікатор профілю клієнта        |
| SegmentProvider      | String       | Додаток, який публікує сегменти. Типове значення: статистика аудиторії         |
