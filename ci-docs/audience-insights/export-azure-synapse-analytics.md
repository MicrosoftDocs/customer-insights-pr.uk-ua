...
description: Дізнайтеся, як настроїти підключення до програми Azure Synapse Analytics.
ms.date: 01/05/2022
ms.reviewer: mhart
...
1. Виберіть додати **підключення** та виберіть **Azure Synapse Analytics** або виберіть **настроїти** на плитці **Azure Synapse Analytics**, щоб настроїти підключення.
...
1. Виберіть сутності, до Azure Synapse Analytics яких потрібно експортувати.
   > [!NOTE]
