...
4. Натисніть кнопку **Настроїти у AI Builder**.

5. Оновіть модель у файлі AI Builder. [Докладніше про керування моделями в AI Builder](/ai-builder/manage-model#retrain-and-republish-existing-models).

Під час наступного запуску прогнозу використовуватиметься оновлена модель.

> [!NOTE]
> Нові моделі, створені в AI Builder новій моделі, не відображатимуться в аналітичних даних аудиторії, якщо модель не була створена з наведених вище подій.
