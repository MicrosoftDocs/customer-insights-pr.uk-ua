...
- Ваше середовище статистики клієнтів має бути приєднано [Microsoft Dataverse до організації](create-environment.md#step-3-connect-to-microsoft-dataverse).
