...
ms.locfileid: "7645013"
---
# <a name="work-with-business-accounts-in-audience-insights"></a>Робота з бізнес-партнерами в аналізі аудиторії

Можливості аналізу аудиторії в Dynamics 365 Customer Insights дають змогу настроювати середовище для різних основних цільових аудиторій: окремих клієнтів (B2C) і бізнес-партнерів (B2B). У сценаріях B2C дані центруються навколо окремих користувачів. Для B2B основними цільовими аудиторіями є бізнес-партнери — організації або компанії — і контактні особи. У цій статті можна знайти інформацію про початок роботи з середовищем для бізнес-партнерів. У ньому перелічені відмінності між областями функцій і аналітикою аудиторії залежно від фокусування на середовищі. Для отримання додаткових відомостей про відмінності перегляньте області функцій. 
