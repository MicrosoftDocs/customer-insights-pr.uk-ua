...
> - Наразі можна налаштувати тільки одну сутність журналу транзакцій. Якщо існує кілька сутностей покупки, об'єднайте їх у Power Query перед виконанням передачі даних.
...
1. Перегляньте усі помилки. Може виникати кілька типів помилок, і у них описуються умови, що призвели до помилки. Наприклад, помилка, що стосується того, що бракує даних для точного прогнозування, зазвичай вирішується, коли до Customer Insights додається більше даних.
