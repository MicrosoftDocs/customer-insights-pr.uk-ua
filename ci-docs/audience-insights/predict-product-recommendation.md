...
1. Якщо поля нижче не заповнені, настройте зв'язки з сутності «Журнал придбань» з сутністю *Клієнт*.
    ...
    1. Введіть Ім'я, що описує зв’язок.
       > [!div class="mx-imgBorder"]
       > ![На сторінці «Журнал придбання» відображається створення зв'язків із клієнтом.](media/model-purchase-join.png "На сторінці «Журнал придбань» відображається створення зв'язку із клієнтом")
