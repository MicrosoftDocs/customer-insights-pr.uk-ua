...
> [!NOTE]
> - Для роботи моделі потрібен журнал транзакцій клієнтів. Наразі можна налаштувати тільки одну сутність журналу транзакцій. Якщо існує кілька сутностей покупки/транзакції, ви можете об'єднати їх у Power Query перед виконанням передачі даних.
