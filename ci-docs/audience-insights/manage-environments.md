...
6. Крім того, ви можете вказати URL-адресу середовища Microsoft Dataverse в розділі **Налаштування спільного доступу до даних і ввімкнення додаткових можливостей Microsoft Dataverse**. Ці можливості передбачають надання спільного доступу до даних програмам і рішенням на основі Microsoft Dataverse, передачу даних з локальних джерел даних та використання [прогнозів](predictions.md). Виберіть **Увімкнути спільний доступ до даних**, щоб надати спільний доступ до вихідних даних Customer Insights, використовуючи службу керованого Data Lake Microsoft Dataverse.
   ...
   Одразу після увімкнення спільного доступу до даних для Microsoft Dataverse буде ініційовано повне оновлення джерел даних та інших процесів. Якщо процеси виконуються чи стоять у черзі, можливість увімкнення спільного доступ до даних за допомогою Microsoft Dataverse не відображатиметься. Зачекайте, поки ці процеси завершаться, або скасуйте їх, щоб увімкнути спільний доступ до даних. 
