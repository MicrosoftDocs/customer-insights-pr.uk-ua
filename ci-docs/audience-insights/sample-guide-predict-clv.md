...
Contoso - компанія, яка виробляє високоякісні кавові та кавові машини. Вони продають продукти через свій веб-сайт Contoso Coffee. Компанія хоче зрозуміти, яку суму (дохід) можна отримати від клієнтів протягом наступних 12 місяців. Якщо вони знатимуть орієнтовну цінність клієнтів протягом 12 місяців, це допоможе скерувати маркетингові зусилля на роботу із найціннішими клієнтами.
...
Тепер, коли уніфіковані профілі клієнтів готові, ми можемо запустити прогнозування цінності життєвого циклу клієнта. Докладні дії прогноз [див](predict-customer-lifetime-value.md).
