...
1. У розкривному списку **Основне** виберіть **eCommerceContacts : eCommerce** як первинне джерело та включайте всі записи.

1. У розкривному списку **Сутність 2** виберіть **loyCustomers : LoyaltyScheme** і включіть всі записи.
...
1. Додайте першу умову за допомогою FullName.
   ...
   - Виберіть розкривне меню **Нормалізувати**, а тоді оберіть **Тип (телефон, ім'я, адреса, ...)**.
