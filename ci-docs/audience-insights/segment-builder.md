...
>    - Переконайтеся, що джерела даних контактних осіб [семантично зіставлено з сутністю ContactProfile](semantic-mappings.md#define-a-contactprofile-semantic-entity-mapping).
