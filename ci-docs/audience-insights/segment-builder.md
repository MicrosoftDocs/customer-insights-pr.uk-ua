...
ms.locfileid: "7377813"
---
# <a name="create-and-manage-segments"></a>Створення сегментів і керування ними

> [!IMPORTANT]
> У вересні 2021 р. у процес створення сегменту було внесено кілька змін: 
> - Конструктор сегментів буде виглядати дещо інакше з оновленими елементами та вдосконаленим користувацьким інтерфейсом.
> - У конструкторі сегментів увімкнуто нові оператори дати й вдосконалений вибір дати.
> - З сегментів можна додавати або видаляти умови та правила. 
> - Будуть доступні вкладені правила, які починаються з умови OR. Умова «І» більше не потрібна на першому шарі.
> - Бічна панель для вибору атрибутів буде постійно доступною.
> - Параметр вибору шляхів до зв'язків сутності.
> Щоб спробувати новий конструктор сегментів, надішліть повідомлення електронної пошти з темою «Запит для ввімкнення нового конструктора сегментів» в cihelp [at] microsoft.com. Додайте ім'я організації та ідентифікатор ізольованого середовища.
