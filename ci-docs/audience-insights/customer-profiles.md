...
[Додайте інші джерела даних](data-sources.md), [збагатіть єдині профілі](enrichment-hub.md) або [створіть сегменти](segments.md) для роботи з єдиними профілями в інших програмах.
