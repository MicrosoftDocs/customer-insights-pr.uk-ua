...
**Експортування сегментів у середовищах для ділових бізнес-партнерів (B2B) або індивідуальних клієнтів (B2C)**  
Більшість варіантів експорту підтримують обидва типи середовищ. Існують особливі вимоги до експортування сегментів у різні цільові системи. Загалом, учасник сегменту, профіль клієнта, містить контактні відомості. Зазвичай це справедливо для сегментів, створених на основі індивідуальних клієнтів (B2C), але це не обов'язково так для сегментів на основі ділових бізнес-партнерів (B2B). 

**Середовища експортів сегментів для ділових бізнес-партнерів (B2B)**  
...
**Експорти сегментів в середовищах для індивідуальних клієнтів (B2C)**  
