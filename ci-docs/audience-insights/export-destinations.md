...
- **Експорти виведення даних** дозволяють експортувати будь-який тип сутності, доступний в аналізі аудиторії. Вибрані для експорту сутності експортуються з усіма полями даних, метаданими, схемами та даними зіставлення. 
- **Експорти сегментів** дозволяють експортувати сутності сегментів зі статистики аудиторії. Сегменти представляють собою списки профілів клієнтів. Під час налаштування експорту слід вибрати включені поля даних, залежно від цільової системи, куди дані експортуватимуться. 
