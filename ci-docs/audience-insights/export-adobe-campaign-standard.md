...
1. Виберіть розділ **Додати підключення**, потім виберіть пункт **Кампанія Adobe**, щоб налаштувати підключення, або виберіть пункт **Налаштувати** на плитці **Кампанія Adobe**
...
1. У полі **Підключення для експорту** виберіть підключення з розділу «Кампанія Adobe». Якщо ім'я цього розділу не відображається, це означає, що для вас немає жодного доступного підключення цього типу.
