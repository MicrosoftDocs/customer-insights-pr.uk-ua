---
title: Транзакція зриву прогноз (містить відео)
...
1. В **області Модель (попередній перегляд) клієнта** виберіть елемент **Трансакція** та натисніть кнопку **Почати**.
...
1. Введіть кількість днів для визначення розриву в **полі визначення** Churn. Наприклад, якщо клієнт не здійснив покупок упродовж останніх 30 днів, його можна розглядати як втраченого для бізнесу. 
...
1. У розділі **Вибір справ виберіть конкретні справи з** вибраного типу справи, на який потрібно зосередитися обчислення.
...
1. На **кроці Додавання необхідних даних** натисніть кнопку **Далі, щоб** продовжити, якщо не потрібно додавати інші справи.
