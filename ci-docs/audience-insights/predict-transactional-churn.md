---
title: Транзакція збивається прогноз (містить відео)
...
> [!TIP]
> Спробуйте підручник для транзакції, що збивається прогноз за допомогою зразків даних: [Транзакція збивається прогноз зразок керівництва](sample-guide-predict-transactional-churn.md).
...
1. Виберіть плитку **Моделі** збивання клієнта та виберіть Використовувати **цю модель**.
