---
title: Прогноз відтоку транзакцій
...
ms.locfileid: "7643457"
---
# <a name="transaction-churn-prediction-preview"></a>Прогноз відтоку транзакцій (підготовча версія)
...
> [!TIP]
> Спробуйте цей посібник й розгляньте прогнозування відтоку транзакцій, скориставшись зразками даних: [Посібник із прикладами для прогнозування відтоку транзакцій (підготовча версія)](sample-guide-predict-transactional-churn.md).
...
- (Необов'язково) Дані про клієнтів:
    - Ці дані зазначаються досить рідко і для забезпечення кращої ефективності моделі мають бути узгоджені із більш статичними атрибутами.
...
1. Зіставте семантичні атрибути із полями, необхідними для запуску моделі. Якщо поля нижче не заповнюються, налаштуйте зв'язок сутності «Журнал придбання» із сутністю *Клієнт*.
...
### <a name="provide-an-optional-list-of-benchmark-accounts-business-accounts-only"></a>Надання необов'язкового списку еталонних бізнес-партнерів (тільки ділові бізнес-партнери)
