...
Наприклад, якщо правило відповідності поєднує в собі прізвище, місто і дату народження, система ідентифікує близнюків з тими ж прізвище, які живуть в тому ж місті, що і той же профіль. Можна вказати виняток, який не відповідає профілям, якщо ім'я в об'єднаних сутностях не збігаються.
