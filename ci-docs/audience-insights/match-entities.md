...
1. Застосування настроюваної відповідності залежить від параметра відповідності, який потрібно використовувати. 
   ...
   - Для **завжди** матчу або ніколи не **збігатися**, перейдіть до наступного кроку.
   - Для **настроюваного обходу** або зіставлення **псевдонімів виберіть елемент Редагувати за** **наявним** правилом відповідності або створіть нове правило. У розкривному списку Нормалізації виберіть **параметр Настроюване обхід** або зіставлення **псевдоніма та натисніть кнопку** **Готово**.
...
Завершивши процес матчу принаймні для однієї пари матчів, перейдіть до [**·**](merge-entities.md) кроку злиття.
