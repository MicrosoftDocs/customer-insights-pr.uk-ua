...
description: Докладніше про системні налаштування в Dynamics 365 Customer Insights можливості статистики аудиторії.
ms.date: 11/01/2021
...
ms.locfileid: "7732395"
---
# <a name="system-configuration"></a>Системна конфігурація

Щоб отримати доступ до конфігурацій системи в аналітичних даних аудиторії, на панелі переходів ліворуч виберіть **·** > **елемент Система** адміністрування, щоб переглянути список системних завдань і процесів.
...
|Статус  |Визначення  |
|---------|---------|
|Скасовано |Обробка була скасована користувачем до її завершення.   |
...
|Пропущені  |Завдання або процес пропущено. Один або кілька процесів, від яких залежить це завдання, завершилися помилкою або були пропущені.|
...
|Поставлено в чергу | Обробка стоїть у черзі і почнеться після завершення всіх завдань і процесів. Для отримання додаткових відомостей [...](#refresh-processes) див.|
...
|Обробити  |Опис  |
|---------|---------|
|справами  |Виконується вручну (одноразове оновлення). Залежить від процесу злиття. Insights залежать від виконання.|
...
|Показники  |Виконується вручну (одноразове оновлення). Залежить від процесу злиття.  |
...
|Користувач  |Виконується вручну (одноразове оновлення). Залежить від сутностей.  |
...
Статистика [клієнтів підтримує багато](/dynamics365/get-started/availability) мов. Програма використовує мовні параметри для відображення таких елементів, як меню, текст підписів і повідомлення, вашою основною мовою.
