...
1. На сторінці **Уніфікація** > **даних** виберіть:
   ...
   - **Уніфікація профілів** клієнтів: запускає відповідні умови та оновлює єдиний профіль клієнта, не впливаючи на залежності (наприклад, збагачення, сегменти або заходи). Залежні процеси не запускаються, але оновлюються, як [визначено в розкладі](system.md#schedule-tab) оновлення.
