...
1. Оцініть, чи потрібно змінювати **Додаткові параметри**. Ці параметри надаються, щоб забезпечити максимальну гнучкість для обробки розширених випадків використання, але значення за замовчуванням будуть адекватними в більшості випадків:
