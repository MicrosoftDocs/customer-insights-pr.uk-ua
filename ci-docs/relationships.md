...
Організації створюють ієрархії бізнес-партнерів, щоб краще керувати бізнес-партнерами та зв'язками між ними. Статистика клієнтів підтримує ієрархії батьківських дочірніх облікових записів, які вже існують у даних клієнтів, які вже існують у даних про клієнтів, які потрапили до мережі. Наприклад, бізнес-партнерів із Dynamics 365 Sales. Ці ієрархії можна настроїти на сторінці "Зв'язки **"**.
