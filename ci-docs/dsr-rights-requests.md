...
Адміністратор Customer Insights може виконати наведені нижче дії, щоб видалити дані клієнта, видалені в джерело даних. Переконайтеся, що запит на видалення був виконаний у вашому джерело даних, перш ніж виконувати наведені нижче дії. 

1. Увійти до Dynamics 365 Customer Insights.
1. Перейти до джерел **даних** > **·**
1. Для кожного джерела даних у списку, що містить видалені дані про клієнта, виконайте зазначені нижче дії.
   1. Виберіть вертикальні три крапки (&vellip;), а потім натисніть кнопку **Оновити**.
...
У рамках нашого зобов'язання співпрацювати з вами під час вашої подорожі до Загального регламенту захисту даних (GDPR), ми розробили документацію, яка допоможе вам відповідати на запити суб'єктів даних.
...
1. Дані будуть видалені (розділи даних і знімки даних), якщо розділи даних і знімки даних неактивні більше 30 днів, тобто вони були замінені новим розділом даних і знімком через оновлення джерел даних.
2. Не всі дані та знімки видаляються. Найновіший розділ даних і знімок даних за визначенням активні, оскільки вони використовуються в Customer Insights. Для найсвіжіших даних не має значення, чи не були джерела даних оновлені протягом останніх 30 днів.
