...
ms.locfileid: "9082775"
---
# <a name="export-data-to-sftp-preview"></a>Експорт даних в SFTP (попередній перегляд)
...
- Пункти призначення SFTP за брандмауерами наразі не підтримуються. 
