...
Домашня **сторінка** проведе вас через процес налаштування ключових функцій і надає огляд сегментів, заходів і даних про збагачення.
...
Використовуйте ліву область, щоб переміщатися між різними областями статистики клієнтів.
