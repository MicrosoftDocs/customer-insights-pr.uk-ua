...
3. Виділіть вертикальні три крапки (&vellip;) у **стовпці Дії** та виберіть пункт **Перегляд**.
...
3. Виділіть вертикальні три крапки (&vellip;) у **стовпці Дії** та натисніть кнопку **Видалити**.
...
- Дозволи програми не надаються.
    ...
    1. Виберіть вертикальні три крапки (&vellip;) поруч із середовищем, до якого потрібно додати дозвіл, і виберіть пункт **Настройки**.
