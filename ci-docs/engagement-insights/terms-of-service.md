...
Статистика взаємодії (попередній перегляд) - це можливість попереднього попереднього перегляду, що означає, що вона має менш або інші заходи безпеки, конфіденційності та розташування даних, ніж функції та можливості, які зазвичай доступні в Dynamics 365 Customer Insights. Перегляньте зазначені нижче умови та документацію з продуктів, щоб визначити, чи підходить засіб аналітичних висновків щодо взаємодії (підготовча версія) для ваших даних.

## <a name="preview-terms-of-service"></a>УМОВИ НАДАННЯ ПОСЛУГ ДЛЯ ПІДГОТОВЧОЇ ВЕРСІЇ

ДАТА ОСТАННЬОГО ОНОВЛЕННЯ: ЖОВТЕНЬ 2020 р. 

Отримуйте доступ до попередніх версій Dynamics 365 Customer Insights або використовуючи їх (разом з будь-якими наданими Корпорацією Майкрософт джерелами даних, "Послугами"), ви приймаєте умови цієї Угоди. Якщо ви не приймаєте їх, не відкривайте та не використовуйте ці Служби.
...
Ця Угода набуває чинності з дати вашої першої згоди на неї. Ця Угода замінює будь-яку попередню угоду, за якою ви використовуєте Dynamics 365 Product Insights або будь-які прекурсори послуг. Ця Угода припиняє дію попередньої з (i) дати першої доступності комерційного випуску Служб (якщо він буде) або (ii) дати, з якої корпорація Майкрософт надасть вам сповіщення про завершення дії угоди. Корпорація Майкрософт може припинити або скасувати використання вами всіх Служб або їх частини або припинити дію цієї Угоди в будь-який час з будь-якої причини на власний розсуд.
