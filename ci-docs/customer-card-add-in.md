...
1. Перегляньте конфігурацію проковтування даних. Відредагуйте джерело даних для системи Dynamics 365, яка містить GUID ідентифікатора контакту. Якщо GUID ідентифікатора контакту відображається з великими літерами в редакторі Power Query, виконайте такі дії:
...
Після повного оновлення системи елементи керування надбудовою картки клієнта повинні відображати очікувані дані.
