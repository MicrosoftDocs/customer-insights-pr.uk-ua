...
Як користувач Customer Insights, у вас, ймовірно, створено [низку](measures.md) заходів, які допоможуть відстежувати ключові показники ефективності (KPI). Важливо розуміти, як певні атрибути впливають на KPI, щоб створити сегменти та запустити точно націлену кампанію.   
