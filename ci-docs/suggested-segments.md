---
title: Пропозиції сегментів (підготовча версія)
...
Як користувач Customer Insights, у вас, ймовірно, створено [ряд](measures.md) заходів, які допомагають відстежувати ваші ключові показники ефективності (KPI). Важливо розуміти, як певні атрибути впливають на KPI, щоб створити сегменти та запустити точно націлену кампанію.   
...
Виберіть запропонований сегмент, щоб переглянути відомості про цю пропозицію. Ви можете також переглянути значення атрибутів або правила, що їх вивчила модель ШІ для того, щоб запропонувати вибраний сегмент.
